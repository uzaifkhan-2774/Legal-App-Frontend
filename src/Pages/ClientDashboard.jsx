...
import ClientCaseTable from "../Components/ClientCaseTable";
...
const ClientDashboard = ()=>{
 ...
 const panelNames = [
    ...
    {
        name : "Create Case",
        classData : "fa-solid fa-building-columns text-sm"
    }
 ]
    ...
    return(
        ...
        <div className="md:w-full md-h-screen">
          < div className="md:flex justify-center text-gray-900 bg-gray-50 p-3 border-b border-gray-300">
           <h1 className="font-bold font-serif text-md text-center ">Client Panel</h1>
          </div>
